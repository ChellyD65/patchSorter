...
#        btnq.move(900, 950)   
        btn1 = QPushButton('Interesting', self)
        btn1.setFont(QFont("Arial",18, QFont.Bold))
        btn1.resize(300,100)
#        btn1.move(100,850)
        btn1.clicked.connect(lambda: self.on_click(1))
        
        btn2 = QPushButton('Boring', self)
        btn2.setFont(QFont("Arial",18, QFont.Bold))
        btn2.resize(300,100)
#        btn2.move(600,850)
...
#        self.labelPatch.move(450,850)
        ...
        bottom_area.addWidget(btn1)
        bottom_area.addWidget(self.labelPatch)
        bottom_area.addWidget(btn2)
        bottom_area.addStretch(1)
